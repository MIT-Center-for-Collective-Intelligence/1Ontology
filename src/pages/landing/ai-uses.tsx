                    ...
                    <Box sx={{ pr: { xs: 0, md: 3 } }}>
                      ...
                      >
                        ...
                        >
                          ...
                          to systematically examine the functional scope of AI
                          by organizing tasks through a structured hierarchy of
                        ...
                        >
                          • When a task is heavily automated in one domain, it
                          may signal{" "}
                          <strong style={{ color: "#ff9800" }}>
                    ...
                    <Box sx={{ pl: { xs: 0, md: 3 } }}>
                      ...
                      >
                        ...
                        >
                          ...
                          automatically classify each AI application into the
                          most appropriate node within the verb ontology,
                          leveraging all available textual metadata associated
                          with the Apps to ensure contextual accuracy and
                          semantic alignment.
                        </Typography>
                      </Box>
                    </Box>
                ...
                <Grid container spacing={8}>
                  <Grid item xs={12} md={4}>
                    <Box>
                      ...
                      >
                        The DAG diagram represents hierarchical levels of the
                        verb ontology, progressing from general to specific
                        tasks from left to right, with{" "}
                        <strong style={{ color: "#ff9800" }}>{`"Act"`}</strong>{" "}
                        as the root node at the far left of the structure.
                      </Typography>
                    </Box>
                  </Grid>
                  ...
                  <Grid item xs={12} md={4}>
                    <Box>
                      ...
                      >
                        Color intensity encodes the number of AI Apps associated
                        with that activity.{" "}
                        <strong style={{ color: "#ff9800" }}>
                          Darker shades
                        </strong>{" "}
                        indicate higher concentrations of AI Apps performing
                        that activity.
                      </Typography>
                    </Box>
                  </Grid>
                  ...
                  <Grid item xs={12} md={4}>
                    <Box>
                      ...
                      >
                        By quantifying and visualizing the distribution of AI
                        Apps across this verb taxonomy, we identify{" "}
                        <strong style={{ color: "#ff9800" }}>
                          patterns of concentration
                        </strong>
                        , reveal underrepresented task areas, and assess the
                        breadth and limitations of current AI deployment.
                      </Typography>
                    </Box>
                  </Grid>
                </Grid>

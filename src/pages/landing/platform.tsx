...
const MessageBubble = ({
  ...
  const getContainerStyles = () => {
    const baseStyles = {
      position:
        placement.includes("outside") || position ? "absolute" : "relative",
    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      >
        ...
        >
          ...
          >
            An interactive platform designed for collaborative ontology editing
            and management. Explore its features and capabilities for
            structuring knowledge about work activities.
          </Typography>
        </Container>
                  ...
                  >
                    ...
                    >
                      ...
                      <MessageBubble
                        feature="semanticSearch"
                        placement={
                          isSemanticSearchBreakpoint ? "below" : "outside-left"
                        }
                        arrowPosition={
                          isSemanticSearchBreakpoint ? "top" : "right"
                        }
                        customArrowOffset={
                          isSemanticSearchBreakpoint ? { x: 16 } : { y: 35 }
                        }
                        position={
                          isSemanticSearchBreakpoint
                            ? undefined
                            : {
                                x: scale < 0.9 ? -220 : -270,
                                y: scale < 0.9 ? -22 : -25,
                        ...
                        >
                          <CardContent sx={{ p: 2 }}>
                            ...
                            <MessageBubble
                              ...
                              placement={
                                isSmallDesktop ? "below" : "outside-right"
                              }
                              arrowPosition={isSmallDesktop ? "top" : "left"}
                              customArrowOffset={
                                isSmallDesktop ? { x: 16 } : { y: 15 }
                              }
                              position={
                                isSmallDesktop
                                  ? undefined

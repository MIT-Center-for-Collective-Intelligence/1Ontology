...
export interface LandingHomeSectionProps {
  isAuthenticated: boolean;
  isDark: boolean;
  onGoToSection: (id: LandingSectionId) => void;
}

export const LandingHomeSection: React.FC<LandingHomeSectionProps> = ({
  isAuthenticated,
  isDark,
  onGoToSection,
}) => {
  return (
    <>
      ...
      >
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", maxWidth: "700px", mx: "auto" }}>
            ...
            >
              A comprehensive framework to systematically understand where and
              how AI can be used, and what this means for people and
              organizations.
            </Typography>
            ...
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              <Button
                type="button"
                onClick={() => onGoToSection("platform")}
                variant="contained"
                color="primary"
                size="medium"
              ...
              <Box sx={{ px: 3, position: "relative", zIndex: 2 }}>
                ...
                >
                  ...
                  >
                    ...
                    in the activities and processes people and computers do
                    today.
                  </Typography>
                  ...
                  >
                    ...
                    to automatically predict where and how AI can be used and
                    help people flourish through this transition.
                  </Typography>
                </Box>
              </Box>
            </Grid>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 0 }}>
                  ...
                  <Box sx={{ pt: 4 }}>
                    ...
                    >
                      ...
                      >
                        Develop appropriate policies and transition programs to
                        help workers
                      </Typography>
                    </Box>
                  </Box>
                      ...
                      <Box sx={{ pt: 4 }}>
                        ...
                        >
                          <Box>
                            ...
                            >
                              Predicting which jobs will be automated vs
                              augmented
                            </Typography>
                          </Box>
                      ...
                      >
                        ...
                        >
                          ...
                          <Box>
                            ...
                            >
                              Fitting models to experimental data comparing
                              humans, humans with AI, and AI in different
                          ...
                          <Box>
                            ...
                            >
                              Working with industry partners to map their
                              operations to our ontology and identify AI use
                              cases
                            </Typography>
                          </Box>
                        </Box>
      ...
      >
        ...
        <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
          ...
          <Box sx={{ mb: 6, maxWidth: "600px", mx: "auto" }}>
            ...
            >
              Specializations {`"inherit"`} (and may {`"over-ride"`}) properties
              from their generalizations:
            </Typography>
          ...
          >
            ...
            >
              <Box
                component="img"
                src={
                  isDark ? "/inheritance_dark.jpg" : "/inheritance_light.jpg"
                }
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Box sx={{ textAlign: "center" }}>
            ...
            >
              Access our comprehensive ontology editing platform and contribute
              to advancing our understanding of AI integration in work
              processes.
            </Typography>
      ...
      {/* Footer */}
      <Footer isDark={isDark} onLandingSectionChange={onGoToSection} />
    </>
  );
};

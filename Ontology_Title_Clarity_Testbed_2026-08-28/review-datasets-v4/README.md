...
The branch-by-evidence-bucket extrapolation yields 26,765 groups and 47,256 model calls. Its central ACCESS planning allowance is about 76 million tokens, with 8.5 modeled hours at 32-way concurrency. These are fragile sensitivity scenarios, not measured cost or duration.

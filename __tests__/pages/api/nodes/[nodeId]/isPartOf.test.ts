...
describe('/api/nodes/[nodeId]/isPartOf GET endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  // it('should return an empty collection if node has no isPartOf collections', async () => {
  //   const testNode = createTestNode({
  //     properties: {
  //       parts: [{ collectionName: 'main', nodes: [] }],
  //       isPartOf: [] // Empty array
  //     }
  //   });
  ...
  //   // Expect response with empty main collection
  //   const responseData = expectSuccessResponse(res, 200) as ApiResponse<{ containers: ICollection[] }>;
  //   expect(responseData.data?.containers).toEqual([[{ collectionName: 'main', nodes: [] }], []]);
  // });
...
describe('/api/nodes/[nodeId]/isPartOf POST endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
describe('/api/nodes/[nodeId]/isPartOf DELETE endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
describe('/api/nodes/[nodeId]/isPartOf PUT endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
describe('/api/nodes/[nodeId]/isPartOf method validation', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
//   console.log('Handler module contains:', Object.keys(actualHandlerModule));

//   const { req, res } = createMocks<NextApiRequestWithAuth, NextApiResponse>({
//     method: 'GET',
//     query: { nodeId: 'test-node-id' }
//   });
  
//   req.apiKeyInfo = null;
  
//   if (actualHandlerModule.methodHandler) {
//     await actualHandlerModule.methodHandler(req, res);
//   } else {
//     // Call the default export which should be the wrapped handler
//     await actualHandlerModule.default(req, res);
//   }
...
describe('/api/nodes/[nodeId]/isPartOf integration tests', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
